<x-layout>
    ...
    <!-- Mitra Perusahaan Carousel -->
    <div class="embla overflow-hidden">
        <div class="embla__viewport">
            <div class="embla__container flex">
                <div class="embla__slide min-w-full">
                    <div class="grid grid-cols-4 gap-4 justify-items-center">
                        <img src="img/mp/mp1.png" class="w-20" alt="Company 1">
                        <img src="img/mp/mp2.png" class="w-20" alt="Company 2">
                        <img src="img/mp/mp3.png" class="w-20" alt="Company 3">
                        <img src="img/mp/mp4.png" class="w-20" alt="Company 4">
                    </div>
                </div>
                <div class="embla__slide min-w-full">
                    <div class="grid grid-cols-4 gap-4 justify-items-center">
                        <img src="img/mp/mp5.png" class="w-20" alt="Company 5">
                        <img src="img/mp/mp6.png" class="w-20" alt="Company 6">
                        <img src="img/mp/mp7.png" class="w-20" alt="Company 7">
                        <img src="img/mp/mp8.png" class="w-20" alt="Company 8">
                    </div>
                </div>
            </div>
        </div>
    ...
    <button
        class="embla__prev absolute left-0 top-1/2 -translate-y-1/2 bg-gray-800 text-white p-2 rounded-full">◀</button>
    <button
        class="embla__next absolute right-0 top-1/2 -translate-y-1/2 bg-gray-800 text-white p-2 rounded-full">▶</button>



    <!-- Mitra Yayasan Carousel -->
    <div class="embla overflow-hidden mt-8">
        <div class="embla__viewport">
            <div class="embla__container flex">
                <div class="embla__slide min-w-full">
                    <div class="grid grid-cols-4 gap-4 justify-items-center">
                        <img src="img/my/my1.png" class="w-20" alt="Foundation 1">
                        <img src="img/my/my2.jpg" class="w-20" alt="Foundation 2">
                        <img src="img/my/my3.png" class="w-20" alt="Foundation 3">
                        <img src="img/my/my4.png" class="w-20" alt="Foundation 4">
                    </div>
                </div>
                <div class="embla__slide min-w-full">
                    <div class="grid grid-cols-5 gap-4 justify-items-center">
                        <img src="img/my/my5.png" class="w-20" alt="Foundation 5">
                        <img src="img/my/my6.png" class="w-20" alt="Foundation 6">
                        <img src="img/my/my7.jpeg" class="w-20" alt="Foundation 7">
                        <img src="img/my/my8.jpeg" class="w-20" alt="Foundation 8">
                        <img src="img/my/my9.png" class="w-20" alt="Foundation 9">
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", () => {
            document.querySelectorAll(".embla").forEach((emblaNode) => {
                const viewport = emblaNode.querySelector(".embla__viewport");
                const prevButton = emblaNode.parentElement.querySelector(".embla__prev");
                const nextButton = emblaNode.parentElement.querySelector(".embla__next");
