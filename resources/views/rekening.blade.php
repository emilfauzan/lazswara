        ...
        <div class="content-center rounded-lg justify-center items-center px-2 py-4">
            ...
            <div class="grid grid-cols-10 gap-2 mx-2 my-2 mb-6">
                ...
                <button id="copyButton"
                    class="px-4 py-2 text-center rounded-lg border-2 cursor-pointer bg-gray-200 hover:bg-gray-300">
                    <p>
                        Copy
                    </p>
                </button>
                ...
                <div id="copySuccessModal"
                    ...
                    <div
                        class="bg-teal-700/30 px-6 py-4 rounded-md shadow-md text-center w-auto sm:w-full sm:rounded-none">
                        <p class="text-white font-semibold flex items-center justify-center gap-1.5 ltr:sm:justify-start rtl:sm:justify-end">
        ...
        document.getElementById('copyButton').addEventListener('click', function() {
            ...
            if (navigator.clipboard && navigator.clipboard.writeText) {
                navigator.clipboard.writeText(text)
                    .then(() => showModal()) // Show modal on success
                    .catch(err => {
