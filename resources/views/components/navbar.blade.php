        ...
        <div class="flex h-16 items-center justify-between">
            ...
            <div class="-mr-2 flex md:hidden">
                ...
                <button type="button" @click="isOpen = !isOpen"
                    class="relative inline-flex items-center justify-center rounded-md border-2 border-gray-700 bg-teal-600/50 p-2 text-gray-700 hover:bg-teal-700 hover:border-gray-500 hover:text-white ease-in-out duration-200 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-900"
