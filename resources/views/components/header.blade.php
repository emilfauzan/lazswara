    ...
    <div class="bg-teal-500/60">
        <div class="grid md:grid-cols-2">
            <div class="md:hidden place-self-center">
                <img class="size-64 drop-shadow-[0_5px_5px_rgba(255,255,255,0.5)]" src="{{ asset('img/logotransparentsqr.png') }}" alt="">
            </div>
            <div
                ...
                <a href="http://wa.me/6285349688826" target="_blank" class="flex bg-teal-800 p-4 px-6 rounded-xl font-bold text-gray-200 hover:bg-teal-600 ease-in-out duration-200 active:bg-teal-900 drop-shadow-lg">
